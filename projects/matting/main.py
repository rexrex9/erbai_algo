...
class Major():
    ...
    def do(self,trace_id,media_path,type,ifbg=True,bg_medio_path=None,out_format='mp4',ifoss=True):
        result_path = self._run(media_path,type,trace_id,ifbg,bg_medio_path,out_format)
        if ifoss:
    ...
    def _run(self,media_path,type,trace_id,ifbg=True,bg_medio_path=None,out_format='mp4'):
        ...
        if type == 'human_figure':
            if input_format in ['png','jpg','jpeg']:
                ...
                raise Exception('input_format must be png or jpg or jpeg')
            ...
            if input_format in ['mp4','mov']:
                ...
                raise Exception('input_format must be mp4 or mov')
        else:
